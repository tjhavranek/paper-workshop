...
- **It rebuilds the paper — it doesn't just review it.** Opt-in second act: CRUCIBLE turns
...
CRUCIBLE mypaper.pdf  summit  brutal           # the most exhaustive pass, brutal register
```
